...
import static unit_tests.MarsRoverBuilder.aMarsRoverAtIrrelevantPosition;
...
public class MarsRoverTest {
    ...
    public void receives_multiple_commands() {
        ...
        assertThat(marsRover, is(aMarsRover().at(8,4).pointing("S").build()));
    }
    ...
    public void ignores_unknown_commands() {
        ...
        assertThat(marsRover, is(aMarsRover().at(7,4).pointing("E").build()));
    }
}
